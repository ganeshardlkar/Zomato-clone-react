    ...
    return (
        <div className="explore-card cur-po">
            ...
            <div className="res-row">
                ...
                {rating && <div className="res-rating absolute-center">{rating}<i class="fa-solid fa-star absolute-center"></i></div>}
            </div>
            <div className="res-row">
                {cuisines.length && <div className="res-cuisine"> {cuisines.map((item, i) => <span className="res-cuisine-tag">{item}{i !== cuisines.length-1 && ","}</span>)} </div>}
            ...
            {bottomContainers.length > 0 && (
                <div>
                    ...
                    <div className="explore-bottom">
                        <img src={bottomContainers[0]?.image?.url} alt={bottomContainers[0]?.image?.text} style={{height: "18px"}} />
